...
export { generateId, getProtocolIdentity } from './core/logic/identity.js';
...
export { evaluateAgeSignal, evaluateDriftSignal, getStaleSignals } from './core/logic/staleness.js';
...
export { createBaseFormatter } from './cli/formatters/index.js';
