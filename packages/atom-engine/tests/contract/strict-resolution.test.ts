...
import { resolveProtocolIdentity } from '../../src/core/logic/protocols.js';
import { type Atom, ProtocolMap } from '../../src/core/types/domain.js';
import { type ProtocolContext } from '../../src/core/types/protocol-definition.js';
import { type QueryTargetAST } from '../../src/core/types/query.js';
import { type RawCommit } from '../../src/interfaces/git-client.js';
import { type EngineInfra } from '../../src/services/engine-bootstrapper.js';
import { findAtomById, findAtomsStream } from '../../src/shell/orchestrators/discovery.js';
import { SYSTEM_PROTOCOL } from '../../src/util/constants.js';
import { ProtocolError } from '../../src/util/errors.js';
...
describe('Phase 4.2: Strict Resolution & System Protocol', () => {
    ...
    it('should throw ProtocolError if multiple line-ranges are provided', async () => {
        ...
        const { createQueryTarget } = await import('../../src/core/logic/query-targets.js');
