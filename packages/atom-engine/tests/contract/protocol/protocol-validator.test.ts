...
import { validateProtocolState, validateProtocolTrailer } from '../../../src/core/logic/validation.js';
import { makeStubProtocolContext, makeStubProtocolState, TEST_ID_KEY, TEST_PROTOCOL_DEFINITION } from '../../../src/testing.js';
