...
import { createQueryTarget, createTargetFromIdentities, getCacheFingerprint, getGitBlameArgs, getGitLogArgs } from '../../../src/core/logic/query-targets.js';
import type { QueryIdentity } from '../../../src/core/types/query.js';
