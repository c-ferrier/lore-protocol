...
import { type FormattableQueryAtom } from '../../../src/core/types/output.js';
import * as Discovery from '../../../src/shell/orchestrators/discovery.js';
import { makeAtom, makeStubProtocolContext, makeStubProtocolMap, makeStubProtocolState, TEST_ID_KEY, TEST_PROTOCOL_DEFINITION } from '../../../src/testing.js';
